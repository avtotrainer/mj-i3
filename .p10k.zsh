# Generated by Powerlevel10k configuration wizard on 2024-01-26 at 00:16 +04.
...
function prompt_my_keyboard_layout() {
  p10k segment -f 208  -t "$(keyboard_layout)"
}
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    public_ip
    load                  # CPU load
    my_keyboard_layout        # keyboard layout
